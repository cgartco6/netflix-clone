...
const CATEGORIZED_MEDIA = {
  ...
  antarctica_docs: [
    { id: 'a0', name: 'Antarctica (2026) Forbidden Documentary', image: 'https://img.youtube.com/vi/GUU1L8XGIYE/maxresdefault.jpg', tag: 'FEATURED', url: 'https://youtu.be/GUU1L8XGIYE?si=iq-jFobgoxHSlY2H', year: '2026' },
...
export default function Home() {
  ...
  return (
    <div style={styles.container}>
      ...
      {/* 📌 FIXED TOP HEADER WITH HORIZONTAL SCROLL NAV */}
      <header style={styles.header}>
        <div style={styles.headerLeftContainer}>
          ...
          <nav style={styles.topNavScroll}>
            <a href="#home" style={styles.topNavLinkActive}>Home</a>
            <a href="#movies" style={styles.topNavLink}>Movies</a>
            <a href="#series" style={styles.topNavLink}>Series</a>
            <a href="#documentaries" style={styles.topNavLink}>Documentaries</a>
            <a href="#extreme" style={styles.topNavLink}>Extreme & Surfing</a>
          </nav>
        </div>
      ...
      <nav style={styles.categoryBar}>
        {['all', 'bokradio', 'sunoai', 'aimusicso', 'music', 'livetv', 'aitech', 'aimusictools', 'crypto', 'antarctica', 'sa'].map((tab) => (
          <button
            key={tab}
          ...
          >
            {tab === 'all' && '🔥 All Rows'}
            {tab === 'bokradio' && '📻 Bok Radio'}
            {tab === 'sunoai' && '🎵 Suno AI'}
            {tab === 'aimusicso' && '🎧 AI Music SO'}
            {tab === 'music' && 'Music & Radio'}
            {tab === 'livetv' && 'Live TV'}
            {tab === 'aitech' && 'AI & Tech'}
            {tab === 'aimusictools' && 'AI Music Tools'}
            {tab === 'crypto' && 'Crypto'}
      ...
      <div style={styles.scrollableContent}>
        ...
        {categories.map((cat, idx) => {
          if (activeCategoryTab !== 'all') {
            ...
            if (activeCategoryTab === 'livetv' && !cat.title.includes('Global')) return null;
            ...
            if ((activeCategoryTab === 'music' || activeCategoryTab === 'bokradio') && !cat.title.includes('Music')) return null;
          }
...
const styles = {
  ...
  header: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 16px', backgroundColor: '#0B0B0B', borderBottom: '1px solid #222', zIndex: 100, flexShrink: 0, overflowX: 'auto', gap: '12px', scrollbarWidth: 'none' },
  headerLeftContainer: { display: 'flex', alignItems: 'center', gap: '12px', flexShrink: 0 },
  headerRightContainer: { display: 'flex', alignItems: 'center', gap: '10px', flexShrink: 0 },
  logo: { color: '#E50914', margin: 0, fontSize: '22px', fontWeight: 'bold', letterSpacing: '1px', flexShrink: 0 },
  movieBoxBtn: { backgroundColor: '#E50914', color: '#FFF', padding: '6px 10px', borderRadius: '4px', textDecoration: 'none', fontWeight: 'bold', fontSize: '12px', whiteSpace: 'nowrap', flexShrink: 0 },
  topNavScroll: { display: 'flex', alignItems: 'center', gap: '16px', overflowX: 'auto', scrollbarWidth: 'none', whiteSpace: 'nowrap' },
  topNavLink: { color: '#AAA', textDecoration: 'none', fontSize: '13px', fontWeight: '500' },
  topNavLinkActive: { color: '#FFF', textDecoration: 'none', fontSize: '13px', fontWeight: 'bold' },
  usbBtn: { backgroundColor: '#28a745', color: '#FFF', padding: '6px 10px', borderRadius: '4px', border: 'none', cursor: 'pointer', fontWeight: 'bold', fontSize: '12px', whiteSpace: 'nowrap', flexShrink: 0 },
  searchForm: { display: 'flex', alignItems: 'center', backgroundColor: '#000', borderRadius: '4px', overflow: 'hidden', border: '1px solid #333', flexShrink: 0 },
  searchSelect: { backgroundColor: '#222', color: '#FFF', border: 'none', padding: '6px 6px', fontSize: '11px', outline: 'none' },
  searchInput: { backgroundColor: 'transparent', border: 'none', color: '#FFF', padding: '6px 8px', outline: 'none', width: '110px', fontSize: '11px' },
  searchButton: { backgroundColor: '#E50914', border: 'none', color: '#FFF', padding: '6px 8px', cursor: 'pointer' },
  categoryBar: { display: 'flex', gap: '8px', padding: '8px 16px', backgroundColor: '#000', borderBottom: '1px solid #222', overflowX: 'auto', flexShrink: 0, zIndex: 90, scrollbarWidth: 'none' },
  categoryTab: { backgroundColor: '#181818', color: '#AAA', border: '1px solid #333', padding: '6px 12px', borderRadius: '6px', cursor: 'pointer', fontSize: '12px', whiteSpace: 'nowrap', flexShrink: 0 },
  activeCategoryTab: { backgroundColor: '#0070F3', color: '#FFF', border: '1px solid #0070F3', padding: '6px 12px', borderRadius: '6px', cursor: 'pointer', fontSize: '12px', fontWeight: 'bold', whiteSpace: 'nowrap', flexShrink: 0 },
  scrollableContent: { flex: 1, overflowY: 'auto', padding: '20px 20px 90px 20px' },
  ...
  bottomDock: { position: 'fixed', bottom: 0, left: 0, right: 0, height: '65px', backgroundColor: '#0B0B0B', borderTop: '1px solid #222', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 20px', zIndex: 1000 },
