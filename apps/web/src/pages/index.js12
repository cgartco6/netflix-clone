...
export default function Home() {
  ...
  return (
    <div style={styles.container}>
      ...
      {/* TOP FIXED MENU: Home, Movies, Series, Documentaries */}
      <header style={styles.topHeader}>
        <div style={styles.topHeaderLeft}>
          <h1 style={styles.logo} onClick={() => scrollToRow('all')}>NETFLIX</h1>
          ...
          <nav style={styles.navLinks}>
            {[
              ...
              { id: 'adventure', label: 'Extreme & Surfing' }
            ].map((t) => (
              <span
                key={t.id}
      ...
      <div style={styles.scrollContainer}>
        ...
        {/* Main Content Rows (Side-Scrolling Carousels) */}
        <main style={styles.main}>
          {/* EXTERNAL HDD / SSD / USB SCANNER ROW */}
          {localDriveItems.length > 0 && (
            <section id="row-drive" style={styles.row}>
          ...
          {/* TOP 10 TODAY */}
          <section id="row-top10" style={styles.row}>
          ...
          {/* FEATURE MOVIES */}
          <section id="row-movies" style={styles.row}>
          ...
          {/* TV SERIES */}
          <section id="row-series" style={styles.row}>
          ...
          {/* DOCUMENTARIES */}
          <section id="row-documentaries" style={styles.row}>
          ...
          <section id="row-adventure" style={styles.row}>
          ...
          <section id="row-radio" style={styles.row}>
          ...
          {/* LIVE TV STATIONS */}
          <section id="row-tv" style={styles.row}>
          ...
          {/* EXPERT AI & TECH */}
          <section id="row-aitech" style={styles.row}>
          ...
          {/* AI MUSIC PLATFORMS */}
          <section id="row-aimusic" style={styles.row}>
          ...
          {/* CRYPTO */}
          <section id="row-crypto" style={styles.row}>
      ...
      {/* BOTTOM FIXED MENU: Music, TV, AI, Crypto */}
      <footer style={styles.bottomHeader}>
        ...
        <div style={styles.bottomNavLinks}>
          {[
            { id: 'radio', label: 'Music & Radio' },
            { id: 'tv', label: 'Live TV' },
            { id: 'aitech', label: 'AI & Tech' },
            { id: 'aimusic', label: 'AI Music Tools' },
            { id: 'crypto', label: 'Crypto' }
          ].map((t) => (
            <button
              key={t.id}
              style={activeTab === t.id ? styles.activeBottomBtn : styles.bottomBtn}
              onClick={() => scrollToRow(t.id)}
            >
              {t.label}
            </button>
...
const styles = {
  container: { backgroundColor: '#141414', height: '100vh', color: '#FFF', fontFamily: 'Helvetica Neue, Helvetica, Arial, sans-serif', width: '100%', overflow: 'hidden', display: 'flex', flexDirection: 'column' },
  
  /* TOP FIXED HEADER */
  topHeader: { position: 'fixed', top: 0, left: 0, right: 0, height: '60px', backgroundColor: 'rgba(20, 20, 20, 0.98)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 3%', zIndex: 200, borderBottom: '1px solid #222' },
  topHeaderLeft: { display: 'flex', alignItems: 'center', gap: '15px' },
  topHeaderRight: { display: 'flex', alignItems: 'center', gap: '10px' },
  logo: { color: '#E50914', margin: 0, fontSize: '22px', fontWeight: 'bold', letterSpacing: '0.5px', cursor: 'pointer' },
  movieBoxBtn: { backgroundColor: '#E50914', color: '#FFF', padding: '4px 10px', borderRadius: '4px', textDecoration: 'none', fontWeight: 'bold', fontSize: '11px' },
  navLinks: { display: 'flex', gap: '12px', marginLeft: '10px' },
  navLink: { color: '#AAA', cursor: 'pointer', fontSize: '12px', transition: 'color 0.2s', whiteSpace: 'nowrap' },
  activeNav: { color: '#FFF', fontWeight: 'bold', cursor: 'pointer', fontSize: '12px', whiteSpace: 'nowrap' },
  usbBtn: { backgroundColor: '#28a745', color: '#FFF', border: 'none', padding: '5px 10px', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold', fontSize: '11px' },
  searchBox: { display: 'flex', backgroundColor: '#000', border: '1px solid #333', borderRadius: '4px', overflow: 'hidden' },
  searchInput: { backgroundColor: 'transparent', border: 'none', color: '#FFF', padding: '4px 8px', outline: 'none', width: '110px', fontSize: '11px' },
  searchBtn: { backgroundColor: '#E50914', border: 'none', color: '#FFF', padding: '4px 8px', cursor: 'pointer' },

  /* CENTER SCROLL CONTAINER */
  scrollContainer: { marginTop: '60px', marginBottom: '60px', flex: 1, overflowY: 'auto', overflowX: 'hidden' },
  billboard: { height: '50vh', backgroundSize: 'cover', backgroundPosition: 'center top', display: 'flex', alignItems: 'flex-end', padding: '0 4% 30px 4%', boxSizing: 'border-box', position: 'relative' },
  billboardContent: { maxWidth: '550px' },
  badge: { color: '#E50914', fontWeight: 'bold', fontSize: '11px', letterSpacing: '1px' },
  billboardTitle: { fontSize: '34px', margin: '6px 0', fontWeight: 'bold', textShadow: '2px 2px 4px rgba(0,0,0,0.8)' },
  billboardDesc: { fontSize: '12px', color: '#DDD', lineHeight: '1.4', margin: '0 0 12px 0' },
  playBtn: { backgroundColor: '#FFF', color: '#000', border: 'none', padding: '7px 18px', fontSize: '13px', fontWeight: 'bold', borderRadius: '4px', cursor: 'pointer' },
  dotsContainer: { position: 'absolute', bottom: '12px', right: '4%', display: 'flex', gap: '8px' },
  ...
  main: { padding: '20px 4%' },
  row: { marginBottom: '25px', scrollMarginTop: '70px' },
  rowTitle: { fontSize: '16px', fontWeight: 'bold', marginBottom: '10px' },
  ...
  cardImg: { width: '160px', height: '220px', objectFit: 'cover', borderRadius: '4px' },
  ...
  rankNum: { fontSize: '100px', fontWeight: '900', color: '#141414', WebkitTextStroke: '3px #555', lineHeight: '0.7', marginRight: '-25px', zIndex: 1 },

  /* BOTTOM FIXED HEADER */
  bottomHeader: { position: 'fixed', bottom: 0, left: 0, right: 0, height: '55px', backgroundColor: 'rgba(20, 20, 20, 0.98)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 3%', zIndex: 200, borderTop: '1px solid #222' },
  bokRadioBtn: { backgroundColor: '#FF8800', color: '#FFF', padding: '4px 10px', borderRadius: '4px', textDecoration: 'none', fontWeight: 'bold', fontSize: '11px' },
  aiMusicBtn: { backgroundColor: '#0070F3', color: '#FFF', padding: '4px 10px', borderRadius: '4px', textDecoration: 'none', fontWeight: 'bold', fontSize: '11px' },
  bottomNavLinks: { display: 'flex', gap: '8px' },
  bottomBtn: { backgroundColor: '#222', color: '#AAA', border: '1px solid #333', padding: '5px 12px', borderRadius: '4px', cursor: 'pointer', fontSize: '11px', whiteSpace: 'nowrap' },
  activeBottomBtn: { backgroundColor: '#E50914', color: '#FFF', border: 'none', padding: '5px 12px', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold', fontSize: '11px', whiteSpace: 'nowrap' },
