...
const MEDIA_CATEGORIES = [
  {
    ...
    items: [
      { id: 'cw1', name: 'Cyberpunk 2099', image: 'https://images.unsplash.com/photo-1578632767115-351597cf2477?w=500', tag: 'S1:E3 • 72%', type: 'video', url: 'https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1' },
      { id: 'cw2', name: 'Antarctica: Truth vs Myth', image: 'https://images.unsplash.com/photo-1517411032315-54ef2cb783bb?w=500', tag: 'DOCUMENTARY', type: 'video', url: 'https://www.youtube.com/embed/L_LUpnjgPso?autoplay=1' }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      { id: 'sar1', name: 'Bok Radio 98.9 FM', image: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=500', tag: 'LIVE AUDIO', type: 'audio', streamUrl: 'https://stream.bokradio.co.za/bokradio' },
      { id: 'sar2', name: 'Jacaranda FM 94.2', image: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=500', tag: 'LIVE AUDIO', type: 'audio', streamUrl: 'https://jacarandafm.streamguys1.com/jacafm-hi' },
      { id: 'sar3', name: 'KFM 94.5 Cape Town', image: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=500', tag: 'LIVE AUDIO', type: 'audio', streamUrl: 'https://primedia.streamguys1.com/KFM' },
      { id: 'sar4', name: 'Metro FM', image: 'https://images.unsplash.com/photo-1526470608268-f674ce90ebd4?w=500', tag: 'LIVE AUDIO', type: 'audio', streamUrl: 'https://sabc.streamguys1.com/metrofm' }
    ]
  },
  {
    title: '🎸 Rock & Heavy Metal Live Radio',
    items: [
      { id: 'rock1', name: 'Classic Rock HD Stream', image: 'https://images.unsplash.com/photo-1498038432885-c6f3f1b912ee?w=500', tag: 'CLASSIC ROCK', type: 'audio', streamUrl: 'https://stream.zeno.fm/f3wvbbqmdg8uv' },
      { id: 'rock2', name: 'Heavy Metal Radio 24/7', image: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=500', tag: 'HEAVY METAL', type: 'audio', streamUrl: 'https://stream.zeno.fm/0r225880508uv' },
      { id: 'rock3', name: 'Alternative Rock Hits', image: 'https://images.unsplash.com/photo-1511735111819-9a3f7709049c?w=500', tag: 'ALT ROCK', type: 'audio', streamUrl: 'https://stream.zeno.fm/3u8v83qmdg8uv' }
    ]
  },
  {
...
export default function Home() {
  ...
  const handleCardClick = (item) => {
    if (item.type === 'audio' && item.streamUrl) {
  ...
  return (
    <div style={styles.container}>
      ...
      {/* Embedded Persistent Audio Player Bar */}
      {currentTrack && (
        <div style={styles.playerBar}>
          ...
          <button style={styles.audioControls} onClick={togglePlayPause}>
            {isPlaying ? '⏸ Pause Radio' : '▶ Resume Radio'}
          </button>
        </div>
      )}
    </div>
...
const styles = {
  ...
  playerBar: { position: 'fixed', bottom: 0, left: 0, right: 0, height: '60px', backgroundColor: '#000', borderTop: '2px solid #E50914', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 30px', zIndex: 1000 },
